...
def test_HD_CH(prodURL, fl_name):
    ...
    print("Step #15 - Check Shelf Description : " + str(jData["product_info"]["shelf_description"]))
    f.write("Step #15 - Checking Shelf Description : \n")
    f.write(str(jData["product_info"]["shelf_description"])+"\n")
    
    ''' Step # 16 - Checking Long Description'''
    print("Step #16 - Check Long Description : " + str(jData["product_info"]["long_description"]))
    ...
    print("Step #18 - Check Keywords :" + str(jData["page_attributes"]["keywords"]))
    f.write("Step #18 - Checking Keywords : \n")
    f.write(str(jData["page_attributes"]["keywords"])+"\n")
